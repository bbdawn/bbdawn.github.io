...
<div class="shot-multi">
  <div class="shot-item">
    ...
    <div class="shot-caption">Prometheus Targets 페이지 (cadvisor·node-exporter 모두 UP 상태)</div>
  </div>
  <div class="shot-item">
    <div class="shot-placeholder">📷 스크린샷 추가 예정</div>
    <div class="shot-caption">Grafana Node Exporter Full 대시보드 시각화 화면</div>
  </div>
</div>
...
<div class="shot-multi">
  <div class="shot-item">
    <div class="shot-placeholder">📷 스크린샷 추가 예정</div>
    <div class="shot-caption">Prometheus target이 DOWN 상태였던 화면</div>
  </div>
  <div class="shot-item">
    <div class="shot-placeholder">📷 스크린샷 추가 예정</div>
    <div class="shot-caption">서비스명으로 수정 후 target UP 확인</div>
  </div>
</div>
