...
<div class="shot-multi">
  <div class="shot-item">
    ...
    <div class="shot-caption">docker compose up 실행 결과</div>
  </div>
  <div class="shot-item">
    <div class="shot-placeholder">📷 스크린샷 추가 예정</div>
    <div class="shot-caption">docker compose ps로 확인한 서비스 상태 (healthcheck 포함)</div>
  </div>
</div>
...
<div class="shot-multi">
  <div class="shot-item">
    <div class="shot-placeholder">📷 스크린샷 추가 예정</div>
    <div class="shot-caption">멀티 스테이지 빌드 실행 로그</div>
  </div>
  <div class="shot-item">
    <div class="shot-placeholder">📷 스크린샷 추가 예정</div>
    <div class="shot-caption">docker images로 비교한 단일/멀티 스테이지 이미지 용량 차이</div>
  </div>
</div>
...
<div class="shot-multi">
  <div class="shot-item">
    <div class="shot-placeholder">📷 스크린샷 추가 예정</div>
    <div class="shot-caption">docker push 실행 결과</div>
  </div>
  <div class="shot-item">
    <div class="shot-placeholder">📷 스크린샷 추가 예정</div>
    <div class="shot-caption">배포 서버에서 docker pull 후 실행 확인</div>
  </div>
</div>
...
<div class="shot-multi">
  <div class="shot-item">
    <div class="shot-placeholder">📷 스크린샷 추가 예정</div>
    <div class="shot-caption">리소스 제한 옵션으로 실행한 컨테이너 확인</div>
  </div>
  <div class="shot-item">
    <div class="shot-placeholder">📷 스크린샷 추가 예정</div>
    <div class="shot-caption">docker stats로 확인한 CPU/메모리 사용량</div>
  </div>
</div>
